...
--> statement-breakpoint
DROP TABLE "dev"."configs" CASCADE;--> statement-breakpoint
DROP TABLE "dev"."users" CASCADE;--> statement-breakpoint
DROP TABLE "dev"."refresh_tokens" CASCADE;--> statement-breakpoint
DROP TABLE "dev"."products" CASCADE;--> statement-breakpoint
DROP TABLE "dev"."product_categories" CASCADE;--> statement-breakpoint
DROP TABLE "dev"."product_images" CASCADE;--> statement-breakpoint
DROP TABLE "dev"."product_addons" CASCADE;--> statement-breakpoint
DROP TABLE "dev"."customers" CASCADE;--> statement-breakpoint
DROP TABLE "dev"."order_item_addons" CASCADE;--> statement-breakpoint
DROP TABLE "dev"."order_items" CASCADE;--> statement-breakpoint
DROP TABLE "dev"."orders" CASCADE;--> statement-breakpoint
DROP TABLE "dev"."order_status_history" CASCADE;--> statement-breakpoint
DROP TABLE "dev"."reservations" CASCADE;--> statement-breakpoint
DROP TABLE "dev"."reservation_status_history" CASCADE;--> statement-breakpoint
